...
# Variables
# Source user defaults to get $term (terminal) if available
if [ -f "$HOME/.config/hypr/UserConfigs/01-UserDefaults.conf" ]; then
    # shellcheck disable=SC1091
    source "$HOME/.config/hypr/UserConfigs/01-UserDefaults.conf"
fi
