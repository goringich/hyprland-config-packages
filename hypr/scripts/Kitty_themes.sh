...
все еще где есть mainMod + shift + enter

 Codebase
Найти все вхождения можно командой — выполните в терминале:

Откроете найденные файлы и поправьте бинды. Например, в уже показанном 